...
void init() {
	...
	initWater();
	initializeFire();
	printf("wasd moves volcano\nr resets and generates new terrain\n"); 	
	fflush(stdout);
...
void reshape(int w, int h) {
  ...
  glLoadIdentity();
  gluLookAt(0.0, 70.0, 110.0, 0.0, 25.0, 0.0, 0.0, 1.0, 0.0);
}
